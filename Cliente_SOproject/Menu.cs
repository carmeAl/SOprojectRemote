...
namespace Cliente_SOproject
{
    public partial class Menu : Form
    {
        ...
        //Timer para refrescar (No se exactamente)
        ...
        {
            //Comprueba si efectivamente está conectado y luego envía la petición de desconexión
            if (conectado)
            {
            ...
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 49:
                        ...
                        Cancelado = true;
                        MessageBox.Show("El rival ha cancelado la Partida");
